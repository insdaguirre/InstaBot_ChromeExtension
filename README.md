...
║  ║                 ║    ║                 ║    ║                 ║        ║
║  ║ • Live Monitor  ║◄──►║ • Selenium Core ║◄──►║ • JSON Database ║        ║
║  ║ • Service Ctrl  ║    ║ • Scheduler     ║    ║ • Action Logs   ║        ║
║  ║ • Configuration ║    ║ • Safety System ║    ║ • User Tracking ║        ║
║  ║ • Real-time Log ║    ║ • Error Recovery║    ║ • Config Store  ║        ║
║  ╚═════════════════╝    ╚═════════════════╝    ╚═════════════════╝        ║
║           │                       │                       │              ║
║           └───────────────────────┼───────────────────────┘              ║
║                                   │                                      ║
...
║  ║                                                                   ║    ║
║  ║  ╔═══════════════╗  ╔═══════════════╗  ╔═══════════════╗        ║    ║
║  ║  ║ Email Alerts  ║  ║ Discord Hooks ║  ║ Error Reports ║        ║    ║
║  ║  ║               ║  ║               ║  ║               ║        ║    ║
║  ║  ║ • Daily Report║  ║ • Real-time   ║  ║ • Critical    ║        ║    ║
║  ║  ║ • Error Alert ║  ║ • Status      ║  ║ • System      ║        ║    ║
║  ║  ║ • Bot Status  ║  ║ • Updates     ║  ║ • Health      ║        ║    ║
║  ║  ╚═══════════════╝  ╚═══════════════╝  ╚═══════════════╝        ║    ║
║  ╚═══════════════════════════════════════════════════════════════════╝    ║
║                                                                           ║
╚═══════════════════════════════════════════════════════════════════════════╝
